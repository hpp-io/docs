...
<CodePanel>
<Tabs groupId="vision-request" queryString>
...
You can use `hpprouter/auto` with multimodal content. Routing follows the same basket/tier rules, and the token estimate includes the image parts. See [Smart Routing](../smart-routing).

## Important distinctions

- **Vision is not image generation.** This endpoint is for *understanding* images in a chat. To *generate* images, use [Image Generation](./image-generation) (`gpt-image-1` at `/v1/images/generations`).
