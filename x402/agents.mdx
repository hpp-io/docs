...
Calling **HPP Router** chat/image specifically (keyless 402, public settlement feed, Agent badge)?
See [HPP Router — x402 Agent (keyless)](/hpp-router/guides/x402-agent).
:::
