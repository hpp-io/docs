...
| `hpp_discover` | browse/search the curated [service directory](./service-directory.mdx) |
...
itself, so after the **first paid call** it's indexed into the [directory](./service-directory.mdx) and other
