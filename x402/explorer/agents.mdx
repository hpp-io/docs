...
| On-chain daily allowance | a Safe-backed wallet ([Pay from an AI agent](../pay-from-an-ai-agent.mdx)) |
...
wallets: [Pay from an AI agent](../pay-from-an-ai-agent.mdx).
...
- **[Pay from an AI agent](../pay-from-an-ai-agent.mdx)** — the full CLI reference and Safe-capped wallets.
